...
const Blog = () => {
    return (
        <div className='md:mx-32 p-5 divide-y-4 my-5'>
            <h1 className='text-center my-2 text-2xl  md:text-3xl font-bold'>Some important Viva Question and Answer</h1>
            <ul className='text-lg md:text-xl  mt-5 '>
